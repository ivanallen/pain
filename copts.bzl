PAIN_GCC_COPTS = ['-Wall', '-Wextra']
PAIN_CLANG_COPTS = ['-Weverything', '-Wno-unknown-warning-option',
                       # 不保持老版本c++语法兼容
                       ...
                       # PAIN_SERIALIZABLE宏内部定义的一些辅助成员在继承场景下会发生同名隐藏
