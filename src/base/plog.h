...
#define __PLOG_PREPROCESS_PAIRS(pairs) BOOST_PP_CAT(__PLOG_ADD_PAREN_1 pairs, _END)
...
inline static auto make_logger(const LoggerOptions& logger_options) {
    ...
    spdlog::init_thread_pool(logger_options.queue_size, logger_options.async_threads);
